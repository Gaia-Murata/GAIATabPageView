...
// GAIATabPageView
#define COCOAPODS_POD_AVAILABLE_GAIATabPageView
#define COCOAPODS_VERSION_MAJOR_GAIATabPageView 0
#define COCOAPODS_VERSION_MINOR_GAIATabPageView 1
#define COCOAPODS_VERSION_PATCH_GAIATabPageView 2
